         ...
         <div class="container">
             ...
             <table class="table table-hover">
                     ...
                     <td style="text-align: right"><?= h($node->modified) ?></td>
                                                                                     ...
                                                                                     <tr>
                     <th><?= __('Active') ?></th>
                     <td style="text-align: right"><?= $node->active ? __('Yes') : __('No'); ?></td>
                 </tr>
                                  <tr>
                     <th><?= __('Published') ?></th>
                     <td style="text-align: right"><?= $node->published ? __('Yes') : __('No'); ?></td>
                 </tr>
                                               </table>
                 ...
                 <div class="panel panel-info">
                     ...
                     <table class="table table-hover">
                         ...
                         <tr>
                             ...
                             <td><?= h($childNodes->active) ?></td>
                             <td><?= h($childNodes->published) ?></td>
                             <td class="actions">
